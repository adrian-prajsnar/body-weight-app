const pl = {
  ...
  dashboard: {
    ...
    averages: 'Statystyki',
    recentHistory: 'Ostatnie 7 pomiarów',
    viewAll: 'Zobacz wszystkie',
    emptyRecent: 'Brak pomiarów.',
  ...
  profile: {
    ...
    birthDateRemoved: 'Data urodzenia usunięta.',
    deleteBirthDate: 'Usunąć datę urodzenia?',
    deleteBirthDateConfirm:
      'Bez daty urodzenia porównania oparte na wieku i statystyki urodzinowe nie będą dostępne. BMI może być mniej dokładne lub oparte na ogólnych kategoriach.\n\nMożesz dodać ją ponownie w dowolnym momencie.',
    sex: 'Płeć',
    sexFemale: 'Kobieta',
    sexMale: 'Mężczyzna',
    sexNotSet: 'Nie chcę podawać',
